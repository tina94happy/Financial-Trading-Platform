...

{
    ...
    meta: { title:"admin list",authLogin:true }
},
{
    path:"adminsadd",
        name:"AdminadminsAdd",
    component: () => import("@/views/admins/add"),
    meta: { title:"add admin",authLogin:true }
},
{
    path:"adminsupdt",
    ...
    meta: { title:"update admins",authLogin:true }
},
{
    path:"adminsupdtself",
    ...
    component: () => import("@/views/admins/updt"),
    meta: { title:"update admins itself",authLogin:true }
},
{
    path:"yonghu",
