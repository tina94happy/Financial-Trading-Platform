        ...
        <e-container class="h-100vh">
            <el-row type="flex" align="center" justify="center" class="h-100vh" style="align-items: center">
                ...
                <el-col :md="8" :offset="1">
                    ...
                    <p>Enter your account number and log in to the system</p>
                    <form action="javascript:;" id="loginForm" name="loginForm" method="post" @submit="login">
                        <div class="form-group mb-4">
                            <el-input type="text" v-model="form.username"
                                      id="username" autofocus placeholder="Account number"></el-input>
                        </div>
                        <div class="form-group mb-4">
                            <el-input type="password" v-model="form.pwd" id="password" placeholder="Password"></el-input>
                        </div>
                        <div class="form-group mb-4">

                            <el-input type="text" v-model="form.pagerandom" name="pagerandom" class="form-control form-control-lg" id="pagerandom" placeholder="CAPTCHA">
                                <span class="input-group-append" slot="append">
                                    <e-img :src="captchUrl" style="min-width: 60px;min-height: 30px;" onClick="this.src='captcha.do?time='+new Date().getTime();" alt="click to refresh"/>
                                </span>
                            </el-input>
                        </div>
                        <div class="form-group mb-4">
                        ...
                        <el-button type="primary" native-type="submit" class="btn btn-primary btn-lg btn-block btn-uppercase mb-4">Login to system</el-button>

                        <div class="text-center">
                            Copyright：{{ setting.title }}
                        </div>
                    </form>
                </el-col>
            </el-row>
        ...
        login() {
            ...
            this.$store.dispatch('user/login', this.form).then(res => {
                ...
                if (res.code == api.code.OK) {
                    this.$message.success('Logging Successfully');
