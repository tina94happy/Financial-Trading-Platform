        ...
        <nav class="navbar">
            ...
            <div class="header-body">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <router-link to="/admin/sy" active-class="active" class="nav-link nav-link-notify">Backstage Home</router-link>
                    </li>
                    <li class="nav-item">
...
export default {
    ...
    methods: {
        logout(){
            this.$confirm('Confirm logging out?','Confirm Information').then(()=>{
                // 退出登录
                this.$store.dispatch('user/logout').then(res=>{
                    if(res.code == api.code.OK)
                    {
                        this.$message.success('Success logging out')
