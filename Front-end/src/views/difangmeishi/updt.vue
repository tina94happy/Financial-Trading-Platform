    ...
    <div class="difangmeishi-add" v-loading="loading">
        <el-card class="box-card">
            <div slot="header" class="clearfix updt">
                                    <el-page-header @back="$router.go(-1)" content="Modify Market Category">
                    </el-page-header>
                            </div>
            ...
            <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                                <el-form-item label="Market Number" prop="meishibianhao" :rules="[{required:true, message:'Please enter market number'}]">
                                            <el-input placeholder="Please enter market number" style="width:250px;" v-model="form.meishibianhao" />                                    </el-form-item>

                                <el-form-item label="Name" prop="mingcheng">
                                            <el-input placeholder="Please enter name" style="width:450px;" v-model="form.mingcheng" />                                    </el-form-item>

                                <el-form-item label="Recommended Stock" prop="fujinjingdian">
...
<el-option v-for="m in meishifenleiList" :value="m.id" :label="m.fenleimingcheng"></el-option>
                                ...
                                <el-form-item label="Real-time Price" prop="jiage" required :rules="[{required:true, message:'Please enter real-time price'}, {validator:rule.checkNumber, message:'Please enter a valid number'}]">
