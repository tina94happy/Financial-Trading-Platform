    ...
    <div class="v-list" v-loading="loading" element-loading-text="loading">
        ...
        <el-card class="box-card">
            <div slot="header" class="clearfix">
                <span class="title">
                Financial Product Related Market
                </span>
            ...
            <div class="form-search">
                <el-form @submit.prevent.stop :inline="true" size="mini">
                    <el-form-item label="Market Number">
                    ...
                    <el-form-item label="Recommended Stock">
            ...
            >
                ...
                <el-table-column label="Market Number" width="130">
                ...
                <el-table-column label="Recommended Stock" width="80">
                    <template slot-scope="{row}">
                        {{ row.fujinjingdian }}
                    </template>
                </el-table-column>
                ...
                <el-table-column label="Market Profile">
                    <template slot-scope="{row}">
                        {{ row.meishijianjie }}
                    </template>
                </el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 删除某行方法
            deleteItem(row) {
                this.$confirm('Do you want to delete the data？', 'Hint', { // 弹出 确认框提示是否要删除
                    type: 'warning'
                }).then(() => {// 确定操作
