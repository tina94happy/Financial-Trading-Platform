        ...
        <el-card class="box-card">
            ...
            <div class="form-database-form">
                ...
                <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                    ...
                    <el-form-item label="Phone" prop="shouji" :rules="[{validator:rule.checkPhone, message:'Please enter valid phone number'}]">
                        <el-input placeholder="Please enter valid phone number" style="width:250px;" v-model="form.shouji" />                                    </el-form-item>


                    <el-form-item label="Email" prop="youxiang" :rules="[{type:'email', message:'Please enter valid email address '}]">
                        <el-input placeholder="Please enter valid email adress" style="width:250px;" v-model="form.youxiang"/>
                    </el-form-item>
